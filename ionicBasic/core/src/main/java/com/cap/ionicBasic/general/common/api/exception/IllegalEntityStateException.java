package com.cap.ionicBasic.general.common.api.exception;

import com.cap.ionicBasic.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link com.cap.ionicBasic.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the ionicBasicEntity entity.
