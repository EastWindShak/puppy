package com.cap.ionicBasic.general.common.api;
...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.cap.ionicBasic.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.cap.ionicBasic.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
