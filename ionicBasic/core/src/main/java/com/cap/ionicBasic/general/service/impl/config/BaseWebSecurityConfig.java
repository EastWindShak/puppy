...
import com.cap.ionicBasic.general.security.JWTAuthenticationFilter;
import com.cap.ionicBasic.general.security.JWTLoginFilter;
...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    http
        ...
        // .passwordParameter(
        // "password"); /*
        // * .and() // logout via POST is possible .logout().logoutSuccessUrl("/login.html").and()
        // */
